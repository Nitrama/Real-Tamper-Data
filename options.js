  ...
  for (item in items) {
    ...
    label.onclick = (function(storageid, item, label) {
      return function() {
        ...
        if (document.getElementById("select_label") != null) {
          document.getElementById("select_label").id = "";
        }
...
document.getElementById("button_activate_url").onclick = function() {
  activate_all("urls");
};
document.getElementById("button_deactivate_url").onclick = function() {
  deactivate_all("urls");
};
document.getElementById("button_activate_file").onclick = function() {
  activate_all("files");
};
document.getElementById("button_deactivate_file").onclick = function() {
  deactivate_all("files");
};
document.getElementById("button_activate_text").onclick = function() {
  activate_all("text");
};
document.getElementById("button_deactivate_text").onclick = function() {
  deactivate_all("text");
};
document.getElementById("button_delete_url").onclick = function() {
  delete_item_from_storage("urls");
};
document.getElementById("button_delete_file").onclick = function() {
  delete_item_from_storage("files");
};
document.getElementById("button_delete_text").onclick = function() {
  delete_item_from_storage("text");
};
document.getElementById("button_new_url").onclick = function() {
  new_string("input_new_url", "urls");
};
document.getElementById("button_new_file").onclick = function() {
  new_string("input_new_file", "files");
};
document.getElementById("button_new_text").onclick = function() {
  new_string("input_new_text", "text");
};
